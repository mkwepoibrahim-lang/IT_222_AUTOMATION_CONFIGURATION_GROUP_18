...
try:
    ...
    print(
        ...
        "Check that SW2 is running in GNS3 and "
    ...
    print(
        f"\nUnexpected error while configuring SW2: "
        f"{error}"
    )
